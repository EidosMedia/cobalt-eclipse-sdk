...
public class SWTFactory {
	...
	public static void showPreferencePage(String id) {
		PreferencesUtil.createPreferenceDialogOn(CobaltSDKPlugin.getShell(), id, new String[] { id }, null).open();
	}
	...
	public static void showPreferencePage(String page_id, String[] page_filters) {
		PreferencesUtil.createPreferenceDialogOn(CobaltSDKPlugin.getShell(), page_id, page_filters, null).open();
	}
}
